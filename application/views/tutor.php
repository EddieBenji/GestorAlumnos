  ...
  <head>
    ...
    <script type="application/javascript">
      function mostrarAltas() {
        ...
        oXmlHttp.open("get", "form_alta_tutor.php", true);
      ...
      function mostrarModificaciones() {
        var oXmlHttp = zXmlHttp.createRequest();
        oXmlHttp.open("get", "form_modificacion_tutor.php", true);
        oXmlHttp.onreadystatechange = function () {
          if (oXmlHttp.readyState == 4) {
            if (oXmlHttp.status == 200) {
              mostrarCRUD(oXmlHttp.responseText);
      ...
      function mostrarConsultas() {
        var oXmlHttp = zXmlHttp.createRequest();
        oXmlHttp.open("get", "form_busqueda_tutor.php", true);
        oXmlHttp.onreadystatechange = function () {
          if (oXmlHttp.readyState == 4) {
            if (oXmlHttp.status == 200) {
              mostrarCRUD(oXmlHttp.responseText);
      ...
      function mostrarBajas() {
        var oXmlHttp = zXmlHttp.createRequest();
        oXmlHttp.open("get", "form_baja_tutor.php", true);
        oXmlHttp.onreadystatechange = function () {
          if (oXmlHttp.readyState == 4) {
            if (oXmlHttp.status == 200) {
              mostrarCRUD(oXmlHttp.responseText);
